                    ...
                    children: <Widget>[
                      new TextField(
                        ...
                        decoration: new InputDecoration(
                            hintText: "Telefone: 10 dígitos", //Translations.of(context).text("enter_code_hint"),
                            labelText: "Telefone", //Translations.of(context).text("enter_code_label"),
                      ...
                      snapshot.data == false
                          ...
                          : new TextField(
                              ...
                              decoration: new InputDecoration(
                                  hintText: "OTP: 4 dígitos",//Translations.of(context).text("enter_otp_hint"),
                                  labelText: "OTP",//Translations.of(context).text("enter_otp_label"),
                                  labelStyle:
                      ...
                      Container(
                        child: snapshot.data == false
                            ? new GradientButton(
                                ...
                                text: "Receber OTP")//Translations.of(context).text("get_otp"))
                            : new GradientButton(
                                onPressed: () {
                                  otp?.length == 4
                      ...
                      snapshot.data == true
                          ? new FlatButton(
                              child: Text("Reenviar OTP"),//Text(Translations.of(context).text("resend_otp")),
                              onPressed: () =>
