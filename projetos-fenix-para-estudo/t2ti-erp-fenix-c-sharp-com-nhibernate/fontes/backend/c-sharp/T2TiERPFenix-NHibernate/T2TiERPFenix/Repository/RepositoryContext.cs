...
namespace T2TiERPFenix.Repository
{
    public class RepositoryContext : DbContext
    {
		...
		public DbSet<FinParcelaPagar> FinParcelaPagars { get; set; }
		public DbSet<FinParcelaReceber> FinParcelaRecebers { get; set; }



		public DbSet<ViewPessoaColaborador> ViewPessoaColaboradors { get; set; }
		public DbSet<ViewFinLancamentoPagar> ViewFinLancamentoPagars { get; set; }
		public DbSet<ViewPessoaCliente> ViewPessoaClientes { get; set; }
		public DbSet<ViewPessoaFornecedor> ViewPessoaFornecedors { get; set; }
