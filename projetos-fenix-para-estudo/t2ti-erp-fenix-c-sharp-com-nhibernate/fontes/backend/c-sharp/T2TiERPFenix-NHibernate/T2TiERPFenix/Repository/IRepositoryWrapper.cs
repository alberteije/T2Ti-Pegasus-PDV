namespace T2TiERPFenix.Repository
{
    public interface IRepositoryWrapper
    {
		...
		IFinParcelaPagarRepository FinParcelaPagar { get; }
		IFinParcelaReceberRepository FinParcelaReceber { get; }




		IViewPessoaColaboradorRepository ViewPessoaColaborador { get; }
		IViewFinLancamentoPagarRepository ViewFinLancamentoPagar { get; }
		IViewPessoaClienteRepository ViewPessoaCliente { get; }
		IViewPessoaFornecedorRepository ViewPessoaFornecedor { get; }
