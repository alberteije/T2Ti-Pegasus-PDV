...
class CreditCardPage extends StatelessWidget {
            ...
            children: <Widget>[
              ...
              Positioned(
                ...
                child: StreamBuilder<String>(
                  ...
                  initialData: "Seu Nome",
                  builder: (context, snapshot) => Text(
                        snapshot.data.length > 0 ? snapshot.data : "Seu Nome",
                        style: TextStyle(
                            color: Colors.white,
                ...
                StreamBuilder<String>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return ProfileTile(
                        ...
                        title: "Expira",
                        subtitle:
                            snapshot.data.length > 0 ? snapshot.data : "MM/AA",
                      );
                    }),
                SizedBox(
                  width: 30.0,
  ...
  Widget floatingBar() => Ink(
        ...
        child: FloatingActionButton.extended(
          onPressed: () => Navigator.pushNamed(_context, "/Payment Success"),
