...
class BancoAgenciaPersistePage extends StatefulWidget {
  ...
  const BancoAgenciaPersistePage(
      {Key key, this.bancoAgencia, this.title, this.operacao})
      : super(key: key);

  @override
  BancoAgenciaPersistePageState createState() =>
      BancoAgenciaPersistePageState();
}
