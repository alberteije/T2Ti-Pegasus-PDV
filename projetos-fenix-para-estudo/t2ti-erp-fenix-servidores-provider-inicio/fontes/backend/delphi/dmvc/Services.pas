...
type
  ...
  public
    ...
    function GetBancos: TObjectList<TBanco>;
...
function TArticlesService.GetBancos: TObjectList<TBanco>;
begin
  FDM.dsArticles.Open('SELECT * FROM BANCO ORDER BY ID');
  Result := FDM.dsArticles.AsObjectList<TBanco>;
  FDM.dsArticles.Close;
end;
