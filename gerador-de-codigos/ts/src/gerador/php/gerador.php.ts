...
export class GeradorPHP extends GeradorBase {
    ...
    arquivoTemplateModel = 'c:/t2ti/gerador.codigo/templates/php/PHP.Model.mustache';
    arquivoTemplateController = 'c:/t2ti/gerador.codigo/templates/php/PHP.Controller.mustache';
    arquivoTemplateService = 'c:/t2ti/gerador.codigo/templates/php/PHP.Service.mustache';
    arquivoTemplateIncludesRotas = 'c:/t2ti/gerador.codigo/templates/php/PHP.Includes.Rotas.mustache';
