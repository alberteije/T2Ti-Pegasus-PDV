                        ...
                        if (this.objetoJsonComentario.desenhaControle == null || this.objetoJsonComentario.desenhaControle == true) {
                            ...
                            if (this.objetoJsonComentario.campoLookupComTabela != 'NAO') {
                                ...
                                if (this.campoModel.tipoDadoOrdenacao == 'num') {
                                    this.dataColumn.push("lista.add(const DataColumn(numeric: true, label: Text('" + this.objetoJsonComentario.label + "')));");
                                } else {
                                    this.dataColumn.push("lista.add(const DataColumn(label: Text('" + this.objetoJsonComentario.label + "')));");
                                }
