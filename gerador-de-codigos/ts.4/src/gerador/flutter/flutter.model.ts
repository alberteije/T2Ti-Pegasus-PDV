    ...
    constructor(tabela: string, dataPacket: CamposModel[], relacionamentos: ComentarioDerJsonModel[]) {
        ...
        for (let i = 0; i < dataPacket.length; i++) {
                ...
                if (this.objetoJsonComentario.tipoControle != null) {
                    if (this.objetoJsonComentario.tipoControle.tipo == 'dropDownButton') {
                        if (this.objetoJsonComentario.tipoControle.persiste != 'valor') { // se for para persistir o valor, não precisamos de get e set - Ex: UF em PESSOA_ENDERECO
                            ...
                            // atributo set
                            atributoSet = "jsonDados['" + this.campoModel.nomeCampoAtributo + "']" + " = set" + this.campoModel.nomeCampoGetSet + "(" + this.campoModel.nomeCampoAtributo + ")";
                            // método set
                        ...
                        if (this.objetoJsonComentario.tipoControle.valorPadrao != null && this.objetoJsonComentario.tipoControle.valorPadrao != '') {
                            atributoConstrutor = this.campoModel.nomeCampoAtributo + " = '" + this.objetoJsonComentario.tipoControle.valorPadrao + "',";
                        }
            ...
            if (atributoConstrutor != '') {
                ...
                atributo = this.campoModel.nomeCampoAtributo;
            ...
            if (this.temMascara) {
                atributo = "jsonDados['" + this.campoModel.nomeCampoAtributo + "']" + " = Biblioteca.removerMascara(" + this.campoModel.nomeCampoAtributo + ");";
            } else {
                if (atributoSet != '') {
                    atributo = atributoSet;
                } else {
                    atributo = "jsonDados['" + this.campoModel.nomeCampoAtributo + "']" + " = " + this.campoModel.nomeCampoAtributo;
                }
                if (this.campoModel.tipoCampo == 'int') {
                    atributo = atributo + ' ?? 0;';
                } else if (this.campoModel.tipoCampo == 'DateTime') {
                    atributo = atributo + " != null ? DateFormat('yyyy-MM-ddT00:00:00').format(" + this.campoModel.nomeCampoAtributo + "!) : null;";
                } else {
                    atributo = atributo + ';';
                }
            }
        ...
        for (let i = 0; i < relacionamentos.length; i++) {
            ...
            if (relacionamento.cardinalidade == '@OneToOne') {
                ...
                if (relacionamento.classeMestre != '' || relacionamento.side == 'Local') {
                    ...
                    this.atributObjConstrutor.push(this.campoModel.nomeCampoAtributo + ',');
                    ...
                    this.atributObjToJson.push("jsonDados['" + this.campoModel.nomeCampoAtributo + "'] = " + this.campoModel.nomeCampoAtributo + " == null ? null : " + this.campoModel.nomeCampoAtributo + "!.toJson;");
                }
                ...
                if (relacionamento.classeMestre != "") {//classe detalhe e inverse não precisa de um objeto da classe mestre - ex: pessoa_fisica, pessoa_contato
                    ...
                    this.atributListConstrutor.push('lista' + this.campoModel.nomeCampoGetSet + ',');
                    ...
                    this.atributListToJson.push("for (" + this.campoModel.nomeCampoGetSet + " objeto in lista" + this.campoModel.nomeCampoGetSet + " ?? []) {");
