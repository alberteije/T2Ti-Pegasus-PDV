...
import { FlutterPersistePageBase } from "../flutter/flutter.persiste.page.base";
import { Biblioteca } from "../../util/biblioteca";

/// classe base que ajuda a gerar a PersistePage do Flutter usando o mustache
export class MoorPersistePage extends FlutterPersistePageBase {
                        ...
                        if ((this.objetoJsonComentario.desenhaControle == null || this.objetoJsonComentario.desenhaControle == true) && this.objetoJsonComentario.linhaBootstrap != null) {
                            ...
                            if (this.campoSendoMontadoEhLookup) {
                                ...
                                if (this.campoModel.nomeCampoTabela.includes('ID_')) {
                                    this.inputController.push("_importa" + this.objetoJsonComentario.classeMestre + "Controller.text = " + this.objetoPrincipal + "?." + this.objetoJsonComentario.objetoMestre + "?." + this.objetoJsonComentario.campoLookup + " ?? '';");
                                    ...
                                    this.inputController.push("_importa" + this.objetoJsonComentario.classeMestre + "Controller.text = " + this.objetoPrincipal + "?." + this.campoModel.nomeCampoAtributo + " ?? '';");
                                }
                            }
    ...
    montarCampoComLookup() {
        ...
        if (this.campoModel.nomeCampoTabela.includes('ID_')) {    
            if (this.objetoJsonComentario.campoLookupTipoDado == "int") {
                this.inputLookup.push("                  " + this.objetoPrincipal + "?." + this.objetoJsonComentario.campoLookupComTabela + " = int.tryParse(text);");
            } else {
                this.inputLookup.push("                  " + this.objetoPrincipal + "?." + this.objetoJsonComentario.campoLookupComTabela + " = text;");
            }
        } else { // se é um campo de lookup para simples consulta, não precisa vincular ao objeto mestre, pois o dado será persistido no campo da própria tabela
            if (this.objetoJsonComentario.campoLookupTipoDado == "int") {
                this.inputLookup.push("                  " + this.objetoPrincipal + "?." + this.campoModel.nomeCampoAtributo + " = int.tryParse(text);");
            } else {
                this.inputLookup.push("                  " + this.objetoPrincipal + "?." + this.campoModel.nomeCampoAtributo + " = text;");
            }
        }
        ...
        if (this.campoModel.nomeCampoTabela.includes('ID_')) {
            this.inputLookup.push("                    " + this.objetoPrincipal + "?." + this.campoModel.nomeCampoAtributo + " = _objetoJsonRetorno['id'];");
            //this.inputLookup.push("                    " + this.objetoMestre + "." + this.objetoPrincipal + "?." + this.objetoJsonComentario.objetoMestre + " = new " + this.objetoJsonComentario.classeMestre + ".fromJson(_objetoJsonRetorno);");
            this.inputLookup.push("                    " + this.objetoPrincipal + "?." + this.objetoJsonComentario.objetoMestre + " = " + this.objetoJsonComentario.classeMestre + ".fromJson(_objetoJsonRetorno);");
        } else { // se é um campo de lookup para simples consulta, não precisa vincular ao objeto mestre, pois o dado será persistido no campo da própria tabela
            this.inputLookup.push("                    " + this.objetoPrincipal + "?." + this.campoModel.nomeCampoAtributo + " = _objetoJsonRetorno['" + this.objetoJsonComentario.campoLookup + "'];");
        }
    ...
    montarTextFormFieldPadrao() {
        ...
        if (this.objetoJsonComentario.tipoControle.mascara != '' && this.objetoJsonComentario.tipoControle.mascara != null) {
            ...
            if (this.campoModel.tipoCampo.includes('decimal')) {
                ...
                this.inputController.push("final _" + this.campoModel.nomeCampoAtributo + "Controller = MoneyMaskedTextController(precision: Constantes." + casasDecimais + ", initialValue: " + this.objetoPrincipal + "?." + this.campoModel.nomeCampoAtributo + " ?? 0);");
            } else {
                ...
                this.inputController.push("  text: " + this.objetoPrincipal + "?." + this.campoModel.nomeCampoAtributo + " ?? '',")
            ...
            if (this.campoModel.tipoCampo.includes('int')) {
                this.inputNormal.push(this.completaEspacosFilhoPadding + "        initialValue: " + this.objetoPrincipal + "?." + this.campoModel.nomeCampoAtributo + "?.toString() ?? '',");
            } else {
                this.inputNormal.push(this.completaEspacosFilhoPadding + "        initialValue: " + this.objetoPrincipal + "?." + this.campoModel.nomeCampoAtributo + " ?? '',");
            }
        }
        ...
        if (this.campoModel.tipoCampo.includes('decimal')) {
            this.inputNormal.push(this.completaEspacosFilhoPadding + "          " + this.objetoPrincipal + " = " + this.objetoPrincipal + "!.copyWith(" + this.campoModel.nomeCampoAtributo + ": _" + this.campoModel.nomeCampoAtributo + "Controller.numberValue);");
        } else if (this.campoModel.tipoCampo.includes('int')) {
            this.inputNormal.push(this.completaEspacosFilhoPadding + "          " + this.objetoPrincipal + " = " + this.objetoPrincipal + "!.copyWith(" + this.campoModel.nomeCampoAtributo + ": int.tryParse(text));");
        } else {
            this.inputNormal.push(this.completaEspacosFilhoPadding + "          " + this.objetoPrincipal + " = " + this.objetoPrincipal + "!.copyWith(" + this.campoModel.nomeCampoAtributo + ": text);");
        }                                
    ...
    montarDropDownButton() {
        ...
        this.inputNormal.push(this.completaEspacosFilhoPadding + "        isEmpty: " + this.objetoPrincipal + "!." + this.campoModel.nomeCampoAtributo + " == null,");
        this.inputNormal.push(this.completaEspacosFilhoPadding + "        child: getDropDownButton(" + this.objetoPrincipal + "!." + this.campoModel.nomeCampoAtributo + ", (String? newValue) {");
        this.inputNormal.push(this.completaEspacosFilhoPadding + "            _formFoiAlterado = true;");
        this.inputNormal.push(this.completaEspacosFilhoPadding + "            setState(() {");                                
        this.inputNormal.push(this.completaEspacosFilhoPadding + "              " + this.objetoPrincipal + " = " + this.objetoPrincipal + "!.copyWith(" + this.campoModel.nomeCampoAtributo + ": newValue);");
    ...
    montarDatePickerItem() {
        ...
        this.inputNormal.push(this.completaEspacosFilhoPadding + "          dateTime: " + this.objetoPrincipal + "!." + this.campoModel.nomeCampoAtributo + ",");
        ...
        this.inputNormal.push(this.completaEspacosFilhoPadding + "              _formFoiAlterado = true;");
        this.inputNormal.push(this.completaEspacosFilhoPadding + "              setState(() {");
        this.inputNormal.push(this.completaEspacosFilhoPadding + "                " + this.objetoPrincipal + " = " + this.objetoPrincipal + "!.copyWith(" + this.campoModel.nomeCampoAtributo + ": value);");
