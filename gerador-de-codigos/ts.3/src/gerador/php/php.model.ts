        ...
        for (let i = 0; i < dataPacket.length; i++) {
            ...
            if (this.campoModel.nomeCampoTabela.includes('ID_') && this.campoModel.Comment != '') {
                ...
                if (this.campoModel.nomeCampoTabela == 'ID') {
                    ...
                    atributo = atributo + ' */\n\t';
                    atributo = atributo + 'private $' + this.campoModel.nomeCampoAtributo + ';\n';
                } else {
                    atributo = atributo + '/**\n\t';
                    atributo = atributo + ' * @ORM\\Column(type="' + tipoDado + '", name="' + this.campoModel.nomeCampoTabela + '")\n\t';
                    atributo = atributo + ' */\n\t';
                    atributo = atributo + 'private $' + this.campoModel.nomeCampoAtributo + ';\n';
                }
                ...
                let get = 'public function get' + this.campoModel.nomeCampoGetSet + '() \n\t{\n\t\t';
                if (tipoDado == 'date') {
                    get = get + "if ($this->" + this.campoModel.nomeCampoAtributo + " != null) {\n\t\t\t";
                    get = get + "return $this->" + this.campoModel.nomeCampoAtributo + "->format('Y-m-d');\n\t\t";
                    get = get + "} else {\n\t\t\t";
                    get = get + "return null;\n\t\t}\n\t}\n\t";
                } else {
                ...
                let set = 'public function set' + this.campoModel.nomeCampoGetSet + '($' + this.campoModel.nomeCampoAtributo + ') \n\t{\n\t\t';
                if (tipoDado == 'date') {
                    set = set + '$this->' + this.campoModel.nomeCampoAtributo + ' = $' + this.campoModel.nomeCampoAtributo + ' != null ? new \\DateTime($' + this.campoModel.nomeCampoAtributo + ') : null;\n\t}\n';
                } else {
                ...
                if (this.campoModel.nomeCampoTabela != 'ID') {
                    let mapeamento = "$this->set" + this.campoModel.nomeCampoGetSet + "($objeto->" + this.campoModel.nomeCampoAtributo + ");";
                    this.mapeamentoSimples.push(mapeamento);
                }

                // serializa os atributos para JSON
                let serial = "'" + this.campoModel.nomeCampoAtributo + "' => $this->get" + this.campoModel.nomeCampoGetSet + "(),";
