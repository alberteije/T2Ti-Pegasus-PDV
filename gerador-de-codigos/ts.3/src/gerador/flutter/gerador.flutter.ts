...
import { GeradorFlutterAba } from "./gerador.flutter.aba";
...
export class GeradorFlutter extends GeradorBase {
    ...
    async gerarArquivos(tabela: string, result: (retorno: any, erro: any) => void) {
        ...
        // gera os arquivos mestre-detalhe
        let geradorFlutterAbas = new GeradorFlutterAba();
        await geradorFlutterAbas.gerarArquivos(tabela, (resposta: any, erro: any) => {
            if (erro != null) {
